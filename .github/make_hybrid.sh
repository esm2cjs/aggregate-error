...
replace_imports "clean-stack"
replace_imports "indent-string"
...
PJSON=$(cat package.json | jq --tab '
	...
	| .dependencies["@esm2cjs/clean-stack"] = .dependencies["clean-stack"]
	| del(.dependencies["clean-stack"])
	| .dependencies["@esm2cjs/indent-string"] = .dependencies["indent-string"]
	| del(.dependencies["indent-string"])
